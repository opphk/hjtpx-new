<template>
  <div class="captcha-rotate">
    <div class="captcha-rotate__container">
      ...
      <div class="captcha-rotate__reference" v-if="showReference && referenceImage">
        <img :src="referenceImage" alt="参考图片" class="captcha-rotate__image" />
      </div>
    </div>
...
const props = withDefaults(defineProps<CaptchaRotateProps>(), {
  targetImage: '',
  referenceImage: '',
  targetAngle: 0,
  tolerance: 15,
