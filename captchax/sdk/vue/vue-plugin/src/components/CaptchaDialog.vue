...
import CaptchaClick from './CaptchaClick.vue';
import CaptchaPuzzle from './CaptchaPuzzle.vue';
import CaptchaRotate from './CaptchaRotate.vue';
import CaptchaText from './CaptchaText.vue';
import CaptchaIcon from './CaptchaIcon.vue';
import { useCaptcha } from '../composables/useCaptcha';
import { useCaptchaState } from '../composables/useCaptchaState';
import type { CaptchaDialogProps, CaptchaType } from '../types';
...
const componentMap: Record<CaptchaType, any> = {
  slider: CaptchaSlider,
  click: CaptchaClick,
  puzzle: CaptchaPuzzle,
  rotate: CaptchaRotate,
  text: CaptchaText,
  icon: CaptchaIcon
};

const currentComponent = computed(() => {
  return componentMap[props.type] || CaptchaSlider;
});
