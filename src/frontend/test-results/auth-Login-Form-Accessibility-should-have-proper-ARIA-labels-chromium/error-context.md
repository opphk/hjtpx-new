...
Call log:
  ...
  - waiting for locator('input[name="email"]')
    11 × locator resolved to <input value="" id="email" type="text" required="" name="email" class="form-input" placeholder="请输入邮箱" aria-invalid="false" aria-required="true" aria-disabled="false"/>
